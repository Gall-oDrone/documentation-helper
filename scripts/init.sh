...
conda activate /opt/anaconda3/envs/documentation-helper || { echo "Error: Failed to activate the documentation-helper environment."; exit 1; }

# Verify the activation
which python || { echo "Error: Python not found in the documentation-helper environment."; exit 1; }
